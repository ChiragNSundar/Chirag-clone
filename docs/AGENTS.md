...
- **LLM**: LM Studio (local primary via localhost:1234), Offline RAG + Context Files (fallback)
- **RAG & Context**: BM25 + Vector Search over `backend/data/context/` (.txt, .md, .json)
- **Logging**: Structlog / Standard Logging fallback
